...
\lstinputlisting[style=colorC++,caption={number_series.h}]{./number_series.h}
\lstinputlisting[style=colorC++,caption={number_series.cpp}]{./number_series.cpp}
\lstinputlisting[style=colorC++,caption={number_series_wrap.cpp}]{./number_series_wrap.cpp}
\lstinputlisting[style=colorC++,caption={main}]{./main.cpp}
\end{document}
