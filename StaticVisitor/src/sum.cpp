//
// Created by rasmu on 22/03/2023.
//
 ...
 * 1) Implement a function "sum" with one argument of type std::in<int> returning int, see std::accumulate. Done.
...
//Voradic template
int sum(Args &&... args) { //Parameter pack
//binary left fold. ( init op ... op pack )
// In this case accum. is init
...
SUBCASE("6) type-check the container") {
    auto s = sum(50); // gives a nice type error :)
}
*/
}
